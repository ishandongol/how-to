...
void MAINMenu :: events(SDL_Renderer *texture_renderer,buttons howtoBut, buttons help, buttons options,
                        ...
                        MAINMenu howto_logo, MAINMenu hamro_logo,int*p, float frameTime, int prevTime, int currentTime, float deltaTime,float frameTime2,MAINMenu *clouds, MAINMenu *bird,bool top){
    while(main_event){
...
void MAINMenu :: event_drag(SDL_Renderer *texture_renderer,buttons howtoBut, buttons help, buttons options, buttons credits, buttons quit, MAINMenu howto_back,MAINMenu howto_logo,MAINMenu hamro_logo,int*p
                            ,float frameTime, int prevTime, int currentTime, float deltaTime,float frameTime2,MAINMenu *clouds,MAINMenu *bird,bool top){
    while(drag_run){
            cout<<top<<endl;
          prevTime=currentTime;
        currentTime=SDL_GetTicks();
