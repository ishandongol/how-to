...
public:
    ...
    void events(SDL_Renderer*,buttons,buttons,buttons,buttons,buttons,buttons,MAINMenu,MAINMenu,MAINMenu,int*, float, int, int, float,float, MAINMenu *, MAINMenu *,bool);
    void event_drag(SDL_Renderer *,buttons,buttons,buttons,buttons,buttons,MAINMenu,MAINMenu,MAINMenu,int*,float, int, int, float,float, MAINMenu*, MAINMenu *,bool);
    void update(int,int);
    void free_resources();
    bool main_event;
    bool drag_run;
...
public:
    ...
    void drag_event(SDL_Renderer*, buttons*, buttons*, bool*,bool*,MAINMenu,buttons,buttons,buttons,buttons);
    /* ~subMENU3(){
    free_resources();
    }*/
    //void event_drag(SDL_Renderer *);
